...
<html>
    ...
    <body>
        <div id="wrapper">
            <h2>添加分类<a href="javascript:history.go(-1)">返回</a></h2>
            <form action="<?php echo U('insert');?>" method="post" enctype="multipart/form-data">
                <table class="form">
                    ...
                    <tr><td class="tkey"><span class="red">*</span>类别名称：</td><td><input type="text" name="title" class="input_text" /></td></tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp;<span class="red">此项只在针对一级分类有效，可以导航管理中进行修改！</span>
                        </td>
                    </tr>
