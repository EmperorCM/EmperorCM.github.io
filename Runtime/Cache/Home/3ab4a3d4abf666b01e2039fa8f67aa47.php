...
<head>
    ...
    <title>资讯列表-<?php echo Site('sitename');?></title>
            ...
            <div class="news-list-content">
                <div class="news-tab">
                    <ul class="clearfix">
                        ...
                        <li>
                            <a href="/news/16" class="last-none">媒体</a>
                        </li>
                        <li></li>
                    </ul>
                </div>
                    ...
                    <div class="news-list">
                        <ul>
                        	<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
	                                <span class="time"><?php echo (date('Y-m-d H:i:s',$vo["create_time"])); ?></span>
	                                <a href="/p_<?php echo ($vo["id"]); ?>"><strong>[<?php echo ($class[$vo["id]"]); ?>]</strong><?php echo ($vo["title"]); ?></a>
