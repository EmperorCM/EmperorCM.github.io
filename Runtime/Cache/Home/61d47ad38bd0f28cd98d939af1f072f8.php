...
<head>
    ...
    <title>模卡精选 - <?php echo Site('sitename');?></title>
    ...
    <div class="container">
        ...
        <div class="rec-page">
            <div class="rec-title clearfix">
                ...
                <a href="/model/" class="more">模卡总览</a>
            </div>
            <div class="rec-content">
                <ul class="rec-list clearfix">
                     <?php if(is_array($model["picList"])): $i = 0; $__LIST__ = $model["picList"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <a href="javascript:void(0)" onclick="view.changeImg(<?php echo ($i-1); ?>)">
                                <img src="<?php echo ($vo); ?>" />
                                <span><?php echo ($model["intro"][$i-1]); ?></span>
                            </a>
...
<script>
    ...
    <script>
        var imgList=[<?php echo ($modelList); ?>];
