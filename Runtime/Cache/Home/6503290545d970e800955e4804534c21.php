...
<head>
    ...
    <title>女神联盟 - <?php echo Site('sitename');?></title>
    ...
    <link href="<?php echo C('WEB_URL');?>Public/ruili/css/girl.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<div id="girl" style="margin-top:-40px;">
	<p id="btnNext"><a href="javascript:void(0)" >sdf</a></p>
	<ul class="clearfix">
		<?php if(is_array($girl)): $i = 0; $__LIST__ = $girl;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
				<div class="pic"><img src="/<?php echo ($vo["pic"]); ?>" ><p><?php echo ($vo["name"]); ?></p></div> <div class="info">
					<span>身高：<?php echo ($vo["shengao"]); ?>cm</span>
					<span>体重：<?php echo ($vo["tizhong"]); ?>kg</span>
					<span>鞋码：<?php echo ($vo["xiema"]); ?>码</span>
					<p>三围：<?php echo ($vo["xiongwei"]); ?>cm(胸)  <?php echo ($vo["yaowei"]); ?>cm(腰)  <?php echo ($vo["tunwei"]); ?>cm(臀)</p>
					<p class="mt10"><?php echo ($vo["desc"]); ?></p>
				</div>
...
<script>
	$("#btnNext").on("click",function(){
		$("body").animate({"scrollTop":1080},200);
	})
