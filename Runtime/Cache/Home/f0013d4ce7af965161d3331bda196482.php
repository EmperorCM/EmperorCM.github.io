...
<head>
    ...
    <title><?php echo ($new["title"]); ?> - <?php echo Site('sitename');?></title>
...
right: -92px;}
    ...
    <div class="rl-crumb">
        <a href="/news/">新闻资讯</a> &gt; <a href="/news/<?php echo ($catg); ?>"><?php echo ($title); ?></a>
    </div>
    <div class="container">
        <div class="page-content clearfix">
            <div class="news-list-content">
                ...
                <div class="news-detail-content">
                    <h2 class="title tcenter"><?php echo ($new["title"]); ?></h2>
                    <p class="data" align="right">发表日期：<?php echo (date('Y-m-d',$new["create_time"])); ?> <span class="ml20">浏览量：<?php echo ($new["hit"]); ?></span></p>
                    <div>
